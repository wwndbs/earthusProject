                ...
                <div class="container-fluid px-4"><br>
					...
					<div class="enrollForm">
						<form action="<%=contextPath%>/insert.ch" method="post" id="enrollForm" enctype="multipart/form-data">
							...
							<p>내용</p>
							<textarea name="content" rows="10" style="width:700px; resize: none;"></textarea><br><br>
							
							<p>지급할 포인트</p>
							<input type="number" name="point" min="500" step="500" placeholder="최소 500P부터 500P 단위로 입력" style="width:200px" required> 
							P<br><br><br>
