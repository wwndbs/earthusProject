                ...
                <div class="container-fluid px-4"><br>
                    ...
                    <div class="enrollForm">
                        <form action="<%=contextPath%>/update.ch" method="post" id="updateForm" enctype="multipart/form-data">
                            ...
                            <p>제목</p>
                            <input type="text" name="title" style="width:700px" required value="<%= ch.getChallTitle() %>"><br><br>

                            <p>내용</p>
                            <textarea name="content" rows="10" style="width:700px; resize: none;"><% if(ch.getChallContent() != null) { %><%= ch.getChallContent() %><% } %></textarea><br><br>
